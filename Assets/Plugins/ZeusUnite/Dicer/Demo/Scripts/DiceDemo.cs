...
public class DiceDemo : MonoBehaviour
{
    ...
    List<TextMeshProUGUI> latestResultTexts = new List<TextMeshProUGUI>();
    ...
    public void RollTheDice()
    {
        if(diceAmount == 1)
        {
            DiceRoller dr = new DiceRoller(1, diceRange);
        ...
        DiceRoller allDices = new DiceRoller(1, diceRange);
